...
export default function PageProjects({ repos }: { repos: RepoType[] }) {
  return (
    <Layout
      title="My Projects"
      withHero={{
        ...
        subtitle: (
          <div>
            My repositories at{' '}
            <a target="__blank" href="https://github.com/arisris">
              https://github.com/arisris
            </a>
          </div>
        )
      }}
    >
      <div className="px-2 grid grid-cols-1 md:grid-cols-2 gap-4">
        {repos.map((repo, index) => (
          ...
          >
            <a className="" href={repo.html_url} target="__blank">
